...
import (
	...
	mongoRC "payment-service/internal/modules/payment/repositories/commands"
...
type CommandTestSuite struct {
	...
	repository  payment.MongodbRepositoryCommand
	ctx         context.Context
}
...
func (suite *CommandTestSuite) TestInsertOneOrder() {
	...
	// Act
	result := suite.repository.InsertOneOrder(suite.ctx, entity.Order{})
	// Asset
...
func (suite *CommandTestSuite) TestInsertOnePayment() {
	...
	// Act
	result := suite.repository.InsertOnePayment(suite.ctx, entity.PaymentHistory{})
	// Asset
	assert.NotNil(suite.T(), result, "Expected a result")
...
func (suite *CommandTestSuite) TestUpdatePaymentStatus() {
	...
	// Act
	result := suite.repository.UpdatePaymentStatus(suite.ctx, request.UpdatePaymentStatusReq{})
	// Asset
	assert.NotNil(suite.T(), result, "Expected a result")
